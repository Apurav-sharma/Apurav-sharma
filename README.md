...
**AI Intern** — Phoenix Global Lab *(Oct 2025 – Feb 2026)*
Designed and deployed ML models for business intelligence using Python, PyTorch, and scikit-learn; built a conversational AI chatbot for genomics and biological queries using NLP and LLMs; collaborated with a 6-member team on scalable AI systems.
